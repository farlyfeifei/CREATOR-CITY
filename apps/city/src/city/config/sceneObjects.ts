...
export const SCENE_OBJECTS: SceneObjectDef[] = [
  ...
  { kind: "facility", id: "homepage", name: "Personal Homepage", nameCn: "个人主页", desc: "直接播放由个人档案生成的 Remotion 主页影片。", route: "/video", x: 819, y: 80, w: 278, h: 216, color: 0xd94b3f, accent: 0xffd64f, shape: "studio" },
  ...
  { kind: "facility", id: "studio", name: "Creator Profile Studio", nameCn: "个人简历生成馆", desc: "展示当前用户的静态简历、经历与项目档案。", route: "/profile", x: 827, y: 390, w: 166, h: 157, color: 0xd94b3f, accent: 0xffd64f, shape: "studio" },

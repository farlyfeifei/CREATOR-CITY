...
export const SCENE_OBJECTS: SceneObjectDef[] = [
  ...
  { kind: "facility", id: "studio", name: "Creator Profile Studio", nameCn: "个人简历生成馆", desc: "沿用原资料网页，生成个人档案、个人主页与 Remotion 影片。", route: "/video", x: 819, y: 80, w: 278, h: 216, color: 0xd94b3f, accent: 0xffd64f, shape: "studio" },

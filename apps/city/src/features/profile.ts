  ...
  return normalizeProfile({
    ...
    projects: [
      ...
      },
      {
        ...
        name: "Pixel Roundtable · 像素圆桌",
        desc: "qybaihe 的像素多视角讨论产品。本项目只借鉴其圆桌空间、角色化观点与讨论体验，用于 Creator City 的产品设计参考，非本人作品。",
        url: "https://github.com/qybaihe/Roundtable",
        tech: ["SwiftUI", "React", "FastAPI", "PostgreSQL", "Remotion"],
        role: "产品参考（qybaihe，非本人项目）",
        impact: "参考其像素空间与多角色讨论的产品表达方式",
        highlights: ["像素圆桌", "多视角讨论", "角色化表达", "跨端产品"],
        presentationMode: "browser",
        mediaUrl: "/assets/builtin/pixel-roundtable-showcase.jpg",
        mediaType: "image",
        mediaAssetIds: [],
        architecture: ["像素空间", "角色身份", "讨论议题", "观点汇总", "视频输出"],
        workflow: ["进入圆桌", "选择角色", "展开讨论", "沉淀观点"],
        ownership: "reference",
        sourceOwner: "qybaihe",
      },
    ],
